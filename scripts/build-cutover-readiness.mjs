...
const outputDirectory = new URL("../.cutover-readiness-dist/", import.meta.url);
await rm(outputDirectory, { recursive: true, force: true });

await build({
  entryPoints: [fileURLToPath(new URL("../lib/jobs/postgres/cutover-readiness-entry.ts", import.meta.url))],
