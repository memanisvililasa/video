...
const steps = [
  ["01", "Вставьте поддерживаемую ссылку", "Укажите публичный HTTP(S)-адрес файла .mp4, .webm или .mov либо публичную одиночную страницу Vimeo."],
  ["02", "Проверяем источник", "Сервис проверяет URL, redirects, адрес назначения, Content-Type и размер без cookies, пароля или доступа к аккаунтам. Для Vimeo показываются только progressive HTTPS-варианты с видео и аудио."],
