...
const steps = [
  ["01", "Вставьте поддерживаемую ссылку", "Укажите публичный HTTP(S)-адрес файла .mp4, .webm или .mov, одиночную страницу Vimeo, YouTube watch-видео, Short или Reddit-hosted video post."],
  ["02", "Проверяем источник", "Сервис проверяет URL, redirects, адрес назначения, Content-Type и размер без cookies или доступа к аккаунтам. Vimeo использует progressive HTTPS; YouTube и Reddit могут безопасно объединить отдельные видео- и аудиопотоки."],
