...
const steps = [
  ["01", "Вставьте прямую ссылку", "Укажите публичный HTTP(S)-адрес файла .mp4, .webm или .mov. Ссылки на страницы платформ пока не поддерживаются."],
  ["02", "Проверяем источник", "Сервис проверяет URL, redirects, адрес назначения, Content-Type и размер без cookies или доступа к аккаунтам."],
