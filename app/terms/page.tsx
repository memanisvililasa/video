  ...
  return (
    <>
      ...
      <article className="prose-copy mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        <p>Эти условия описывают допустимое использование VideoSave. На Этапе 2 сайт содержит только frontend-интерфейс и не выполняет серверную загрузку видео.</p>
