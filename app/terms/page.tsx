  ...
  return (
    <>
      ...
      <article className="prose-copy mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        <p>Эти условия описывают допустимое использование VideoSave. Personal-use local runtime загружает и обрабатывает публичные прямые видеофайлы и поддерживаемые публичные одиночные страницы Vimeo, YouTube, Shorts и Reddit-hosted video posts только после явного подтверждения прав пользователем.</p>
