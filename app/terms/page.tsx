  ...
  return (
    <>
      ...
      <article className="prose-copy mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        <p>Эти условия описывают допустимое использование VideoSave. Personal-use local runtime загружает и обрабатывает только публичные прямые видеофайлы после явного подтверждения прав пользователем.</p>
