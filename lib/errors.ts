...
export const API_ERROR_MESSAGES: Record<ApiErrorCode, string> = {
  ...
  IMAGE_POST_NOT_SUPPORTED: "Публикации только с изображениями не поддерживаются.",
  CAROUSEL_NOT_SUPPORTED: "Публикации-карусели не поддерживаются.",
  STORY_NOT_SUPPORTED: "Истории не поддерживаются.",
  LIVE_NOT_SUPPORTED: "Прямые эфиры и премьеры не поддерживаются.",
  GROUP_CONTENT_NOT_SUPPORTED: "Контент из групп не поддерживается.",
  MULTI_ITEM_POST_NOT_SUPPORTED: "Публикации с несколькими вложениями не поддерживаются.",
...
export const API_ERROR_STATUS: Record<ApiErrorCode, number> = {
  ...
  IMAGE_POST_NOT_SUPPORTED: 422,
  CAROUSEL_NOT_SUPPORTED: 422,
  STORY_NOT_SUPPORTED: 422,
  LIVE_NOT_SUPPORTED: 422,
  GROUP_CONTENT_NOT_SUPPORTED: 422,
  MULTI_ITEM_POST_NOT_SUPPORTED: 422,
