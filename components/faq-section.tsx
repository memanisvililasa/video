const faqs = [
  ...
  ["Какие источники поддерживаются?", "Прямые публичные ссылки на файлы .mp4, .webm и .mov. Ссылки на страницы платформ пока отклоняются; сервис не обходит авторизацию, приватность или технические ограничения."]
];
