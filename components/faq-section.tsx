const faqs = [
  ...
  ["Какие источники поддерживаются?", "Доступность форматов зависит от публичного источника. Сервис не обходит авторизацию, приватность или технические ограничения."]
];
