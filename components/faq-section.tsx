const faqs = [
  ...
  ["Какие источники поддерживаются?", "Прямые публичные ссылки на .mp4, .webm и .mov, публичные одиночные страницы Vimeo, YouTube-видео и Shorts, а также одиночные Reddit posts с Reddit-hosted video. Playlist, live, gallery, external embed и другие страницы платформ отклоняются; сервис не обходит авторизацию, приватность или DRM."]
];
