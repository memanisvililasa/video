const faqs = [
  ...
  ["Какие источники поддерживаются?", "Прямые публичные ссылки на .mp4, .webm и .mov, публичные одиночные страницы Vimeo с progressive HTTPS-форматом, а также публичные одиночные YouTube-видео и Shorts. Playlist, live и другие страницы платформ отклоняются; сервис не обходит авторизацию, приватность или DRM."]
];
