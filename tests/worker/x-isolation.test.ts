...
describe("X/Twitter worker isolation", () => {
  it("rejects a durable X/Twitter source before metadata, storage, or process execution", async () => {
    const extract = vi.fn();
    ...
    const context = {
      claimed: {
        workItem: {
          sourceUrl: "https://x.com/synthetic_user/status/700000000000000001",
