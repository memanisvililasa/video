...
import type { ProcessClaimContext } from "@/lib/worker/processor";
...
describe("TikTok worker isolation", () => {
  it("rejects a durable TikTok source before extractor, storage, or process execution", async () => {
    const extract = vi.fn();
    ...
    const context = {
      claimed: {
        workItem: {
          sourceUrl: "https://www.tiktok.com/@synthetic/video/7000000000000000001",
